...
public class PublishWechatGroup2Activity extends BaseActivity {
    ...
    public void setContentLayout() {
        setContentView(R.layout.activity_publish_wechat_group2);
    }
...
//        }
        ...
        params.add("tags", tag);
        params.add("groupType", "1");   //0 推广群  1 质量群  默认0
